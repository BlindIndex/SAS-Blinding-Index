...
Source: https://pubmed.ncbi.nlm.nih.gov/8841652/
...
Strongly Believe Placebo  |    n41    |   n42   |         |n41 n42|
...
For Bang's BI, each arm (Treatment and Placebo) assessed separately,
...
Note: the sum of Bang's weights must be zero and weights should be symmetric as described in
...
DIRECTION = 'twosided' - to specify two-sided 95% confidence limits -- DEFAULT
